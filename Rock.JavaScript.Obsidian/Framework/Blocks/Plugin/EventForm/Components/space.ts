...
import { Switch, Modal, Button } from "ant-design-vue"
...
<rck-form ref="form" @validationChanged="validationChange">
  <div class="row">
    ...
    <div class="col col-xs-12 col-md-6" style="display: flex; align-items: end;">
      <a-btn shape="circle" type="accent" @click="map = true" class="mr-1">
        <i class="fas fa-map-marked-alt"></i>
      </a-btn>
      <tcc-validator :rules="[rules.required(e.attributeValues.Rooms, e.attributes.Rooms.name)]" ref="validator_room" style="width: -webkit-fill-available;">
        <tcc-room
