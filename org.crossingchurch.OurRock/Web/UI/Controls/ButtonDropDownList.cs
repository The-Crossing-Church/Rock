...
namespace org.crossingchurch.OurRock.Web.UI.Controls
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class ButtonDropDownList : ListControl, IRockControl, INamingContainer
    {
        ...
        [Bindable( true ), Category( "Appearance" ), DefaultValue( "btn-accent" ), Description( "The button style for active selection" )]
        public string ActiveBtnCSSClass
        {
            get { return ViewState["ActiveBtnCSSClass"] as string ?? string.Empty; }
            set { ViewState["ActiveBtnCSSClass"] = value; }
        }

        [Bindable( true ), Category( "Appearance" ), DefaultValue( "btn-primary" ), Description( "The default button style" )]
        public string DefaultBtnCSSClass
        {
            get { return ViewState["DefaultBtnCSSClass"] as string ?? string.Empty; }
            set { ViewState["DefaultBtnCSSClass"] = value; }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            _listControl = new HtmlGenericControl( "div" );
            _childControlWrapper.Controls.Add( _listControl );
            _listControl.Attributes["class"] = "d-flex justify-center";
        ...
        public void RenderBaseControl( HtmlTextWriter writer )
        {
            ...
            foreach (var item in this.Items.OfType<ListItem>())
            {
                ...
                htmlBuilder.Append( "<a class='btn " );
                if (SelectedValue == item.Value)
                {
                    htmlBuilder.Append( ActiveBtnCSSClass + "'" );
                }
                else
                {
                    htmlBuilder.Append( DefaultBtnCSSClass + "'" );
                }
                if (doPostBack)
                {
                    htmlBuilder.Append( $"onclick=\"__doPostBack('{postbackControlId}', '{this.ID}={item.Value}')\" " );
                }
                ...
                htmlBuilder.Append( $"{item.Text}</a>" );
