...
namespace RockWeb.Blocks.Event
{
    ...
    $('div.radio-content').prev('div.js-rockradiobuttonlist').find('input:radio').unbind('click').on('click', function () {{
        $content = $(this).parents('div.js-rockradiobuttonlist').first().next('.radio-content');
