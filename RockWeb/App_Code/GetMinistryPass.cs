...
using Rock.Data;
using Rock.Model;
using tech.triumph.MinistryPass.Client.Model;
using System.Data.Entity;

namespace tech.triumph.MinistryPass.Client
{
    /// <summary>
    /// Handles retrieving file data from storage
    /// </summary>
    public class GetMinistryPass : IHttpHandler
    {
        ...
        public void ProcessRequest( HttpContext context )
        {
            ...
            // Get pass template
            var ministryPassTemplate = GetMinistryPassTemplate( rockContext );

            if ( ministryPassTemplate == null )
            {
                return;
            }
            ...
            var serialNumber = MinistryPassUtilities.AddUpdateMinistryPass( person, ministryPassTemplate );
            ...
            _response.Redirect( MinistryPassUtilities.GetPassRedirectUrl( serialNumber ) );
        }

        private MinistryPassTemplate GetMinistryPassTemplate( RockContext rockContext )
        {
            ...
            var ministryPassTemplate = new MinistryPassTemplateService( rockContext ).Queryable().AsNoTracking()
