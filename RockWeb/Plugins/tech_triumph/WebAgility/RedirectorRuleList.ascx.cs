...
namespace RockWeb.Plugins.tech_triumph.WebAgility
{
    ...
    /// </summary>
    [DisplayName( "Redirector Rule List" )]
    [Category( "Triumph Tech > Web Agility" )]
    [Description( "Block for listing Redirector Rules." )]
    ...
    public partial class RedirectorRuleList : RockBlock, ICustomGridColumns
    {
        #region Keys
        ...
        {
            base.OnInit( e );
            gRedirectorRules.GridRebind += gTemplateList_GridRebind;
            gRedirectorRules.DataKeyNames = new string[] { "Id" };
            gRedirectorRules.Actions.ShowAdd = true;
            gRedirectorRules.Actions.AddClick += gRedirectorRules_AddClick;
            gRedirectorRules.GridReorder += gRedirectorRules_GridReorder;
            gRedirectorRules.AllowSorting = false;

            bool canAddEditDelete = IsUserAuthorized( Authorization.EDIT );
            gRedirectorRules.IsDeleteEnabled = canAddEditDelete;
        ...
        /// <summary>
        /// Handles the GridReorder event of the gRedirectorRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="GridReorderEventArgs"/> instance containing the event data.</param>
        /// <exception cref="NotImplementedException"></exception>
        private void gRedirectorRules_GridReorder( object sender, GridReorderEventArgs e )
        {
        ...
        private void BindGrid()
        {
            ...
            gRedirectorRules.DataSource = rules;
            gRedirectorRules.DataBind();
        }
        ...
        /// <summary>
        /// Handles the AddClick event of the gRedirectorRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void gRedirectorRules_AddClick( object sender, EventArgs e )
        {
            NavigateToLinkedPage( AttributeKey.DetailPage, "RuleId", 0 );
        }

        /// <summary>
        /// Handles the RowSelected event of the gRedirectorRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RowEventArgs"/> instance containing the event data.</param>
        protected void gRedirectorRules_RowSelected( object sender, RowEventArgs e )
        {
            NavigateToLinkedPage( AttributeKey.DetailPage, "RuleId", e.RowKeyId );
        }
        ...
        /// <summary>
        /// Handles the Delete event of the gRedirectorRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RowEventArgs"/> instance containing the event data.</param>
        protected void gRedirectorRules_Delete( object sender, RowEventArgs e )
        {
            var settings = RedirectorUtilities.ReadSettings();

            var newRuleList = new List<RedirectorRule>();
