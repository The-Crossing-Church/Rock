...
{
    /// <summary>
    /// Block for listing Response Header Rules
    /// </summary>
    [DisplayName( "Response Header Rule List" )]
    [Category( "Triumph Tech > Web Agility" )]
    [Description( "Block for listing Response Header Rules." )]
    ...
    public partial class ResponseHeaderList : RockBlock, ICustomGridColumns
    {
        #region Keys
        ...
        {
            base.OnInit( e );
            gResponseHeaderRules.GridRebind += gTemplateList_GridRebind;
            gResponseHeaderRules.DataKeyNames = new string[] { "Id" };
            gResponseHeaderRules.Actions.ShowAdd = true;
            gResponseHeaderRules.Actions.AddClick += gResponseHeaderRules_AddClick;
            gResponseHeaderRules.GridReorder += gResponseHeaderRules_GridReorder;
            gResponseHeaderRules.AllowSorting = false;

            bool canAddEditDelete = IsUserAuthorized( Authorization.EDIT );
            gResponseHeaderRules.IsDeleteEnabled = canAddEditDelete;
        ...
        /// <summary>
        /// Handles the GridReorder event of the gResponseHeaderRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="GridReorderEventArgs"/> instance containing the event data.</param>
        /// <exception cref="NotImplementedException"></exception>
        private void gResponseHeaderRules_GridReorder( object sender, GridReorderEventArgs e )
        {
        ...
        private void BindGrid()
        {
            ...
            gResponseHeaderRules.DataSource = rules;
            gResponseHeaderRules.DataBind();
        }
        ...
        /// <summary>
        /// Handles the AddClick event of the gResponseHeaderRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void gResponseHeaderRules_AddClick( object sender, EventArgs e )
        {
            NavigateToLinkedPage( AttributeKey.DetailPage, PageParameterKey.RuleId, 0 );
        }

        /// <summary>
        /// Handles the RowSelected event of the gResponseHeaderRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RowEventArgs"/> instance containing the event data.</param>
        protected void gResponseHeaderRules_RowSelected( object sender, RowEventArgs e )
        {
        ...
        /// <summary>
        /// Handles the Delete event of the gResponseHeaderRules control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RowEventArgs"/> instance containing the event data.</param>
        protected void gResponseHeaderRules_Delete( object sender, RowEventArgs e )
        {
            var settings = ResponseHeaderUtilities.ReadSettings();

            var newRuleList = new List<ResponseHeaderRule>();
