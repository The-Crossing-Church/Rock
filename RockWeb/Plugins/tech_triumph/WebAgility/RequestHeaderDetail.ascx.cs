...
{
    /// <summary>
    /// Block for editing Request Header Rules
    /// </summary>
    [DisplayName( "Request Header Rule Detail" )]
    [Category( "Triumph Tech > Web Agility" )]
    [Description( "Block for editing Request Header Rules." )]
    public partial class RequestHeaderDetail : RockBlock
    {
        ...
        private void ShowDetails()
        {
            ...
            var rule = RequestHeaderUtilities.ReadSettings().Rules.Where( r => r.Id == ruleId.Value).FirstOrDefault();
        ...
        protected void lbSave_Click( object sender, EventArgs e )
        {
            ...
            RequestHeaderRule rule = new RequestHeaderRule();
            ...
            else
            {
                ...
                rule.Id = RequestHeaderUtilities.GetNextRuleId();
            }
