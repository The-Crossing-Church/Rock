<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResponseHeaderDetail.ascx.cs" Inherits="RockWeb.Plugins.tech_triumph.WebAgility.ResponseHeaderDetail" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="well">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <Rock:RockTextBox ID="tbHeaderName" runat="server" Label="Header Name" Help="The name portion of the header to include in the HTTP response." />
                        </div>
                        <div class="col-md-4">
                            <Rock:RockTextBox ID="tbHeaderValue" runat="server" Label="Header Value" Help="The value portion of the header to include in the HTTP response." />
                        </div>
                    </div>
