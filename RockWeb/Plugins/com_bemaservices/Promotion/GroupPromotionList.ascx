<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupPromotionList.ascx.cs" Inherits="RockWeb.com_bemaservices.Promotion.GroupPromotionList" %>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gGroups" runat="server" RowItemText="Group" AllowSorting="true" OnRowSelected="gGroups_Edit" CssClass="js-grid-group-list" OnRowDataBound="gGroups_RowDataBound">
                        <Columns>
                            ...
                            <Rock:RockBoundField DataField="PromotesTo" HeaderText="Promotes To" SortExpression="PromotesTo" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
                        </Columns>
                    </Rock:Grid>
