<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomHistoryLog.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Core.CustomHistoryLog" %>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gHistory" runat="server" AllowSorting="true" RowItemText="Change" >
                        <Columns>
                            ...
                            <Rock:DateTimeField DataField="CreatedDateTime" SortExpression="CreatedDateTime" HeaderText="When" FormatAsElapsedTime="false" />
                        </Columns>
                    </Rock:Grid>
                </div>
