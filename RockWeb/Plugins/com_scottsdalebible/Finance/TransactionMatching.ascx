<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionMatching.ascx.cs" Inherits="RockWeb.Plugins.com_scottsdalebible.Finance.TransactionMatching" %>

<style>
    .note-view .form-control-static {
        min-height: 0px;
    }
</style>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
                ...
                <asp:Panel ID="pnlEdit" runat="server">
                    <div class="row">
                        <div class="col-md-5 transaction-matching-image">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:Panel ID="pnlMicrView" runat="server">
                                        <asp:Literal ID="lMicrData" runat="server" />
                                        <asp:LinkButton ID="lbEditMicr" runat="server" CssClass="btn btn-default btn-xs" OnClick="lbEditMicr_Click"><i class="fa fa-pencil"></i></asp:LinkButton>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlMicrEdit" runat="server" Visible="false">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <Rock:RockTextBox ID="tbNewMicr" runat="server" Label="MICR" />
                                                <div class="actions">
                                                    <asp:LinkButton ID="lbSaveMicr" runat="server" CssClass="btn btn-success btn-xs" OnClick="lbSaveMicr_Click"><i class="fa fa-check"></i></asp:LinkButton>
                                                    <asp:LinkButton ID="lbCancelMicr" runat="server" CssClass="btn btn-danger btn-xs" OnClick="lbCancelMicr_Click"><i class="fa fa-minus"></i></asp:LinkButton>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <Rock:RockControlWrapper ID="rcwMicrKey" runat="server" Label="MICR Key">
                                                    <img src="/Assets/Images/pillars/micr_key.png" class="img-responsive" style="max-height: 100px" />
                                                </Rock:RockControlWrapper>
                                            </div>
                                        </div>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlNoteView" runat="server" CssClass="margin-t-md note-view">
                                        <Rock:RockLiteral ID="lNote" runat="server" CssClass="margin-b-none" />
                                        <asp:LinkButton ID="lbEditNote" runat="server" CssClass="btn btn-default btn-xs" OnClick="lbEditNote_Click"><i class="fa fa-pencil"></i></asp:LinkButton>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlNoteEdit" runat="server" CssClass="margin-t-md">
                                        <Rock:RockTextBox ID="tbNote" runat="server" TextMode="MultiLine" Rows="2" />
                                        <asp:LinkButton ID="lbSaveNote" runat="server" CssClass="btn btn-success btn-xs" OnClick="lbSaveNote_Click"><i class="fa fa-check"></i></asp:LinkButton>
                                        <asp:LinkButton ID="lbCancelNote" runat="server" CssClass="btn btn-danger btn-xs" OnClick="lbCancelNote_Click"><i class="fa fa-minus"></i></asp:LinkButton>
                                    </asp:Panel>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7 transaction-matching-details">
                            <div class="header">
                                <div class="row">
                                    <div id="individual_details" class="col-md-6">
                                        ...
                                        <asp:Panel ID="pnlPreview" CssClass="contents clearfix" runat="server">
                                            <asp:LinkButton ID="btnTxnHistory" runat="server" CssClass="btn btn-sm btn-default pull-right" OnClick="btnTxnHistory_Click"><i class="fa fa-history" title="Transaction History"></i></asp:LinkButton>
                                            <asp:LinkButton ID="btnPledges" runat="server" CssClass="btn btn-sm btn-default pull-right margin-r-sm" OnClick="btnPledges_Click"><i class="fa fa-list" title="Pledges"></i></asp:LinkButton>
                                            <asp:Literal ID="lPersonName" runat="server" />
                                            <asp:HiddenField ID="hfSpouseId" runat="server" />
                                            <asp:PlaceHolder ID="phSpouseName" runat="server" Visible="false">
                                                <p>
                                                    <strong>Spouse: </strong>
                                                    <asp:LinkButton ID="btnSpouseName" runat="server" OnClick="btnSpouseName_Click" />
                                                </p>
                                            </asp:PlaceHolder>
                            ...
                            <div class="footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <Rock:PersonPicker ID="ppSoftCredit" runat="server" Label="Soft Credit For" />
                                    </div>
                                </div>
            ...
            <Rock:ModalDialog ID="mdPreviousTransactions" runat="server" Title="Previous Transactions" OnCancelScript="clearActiveDialog();">
                <Content>
                    <Rock:Grid ID="gTransactions" runat="server" EmptyDataText="No Transactions Found" RowItemText="Transaction" DisplayType="Light">
                        <Columns>
                            <Rock:DateField DataField="TransactionDateTime" HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                            <Rock:RockBoundField DataField="AuthorizedPersonAlias.Person.FullName" HeaderText="Person" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                            <Rock:CurrencyField DataField="TotalAmount" HeaderText="Amount" />
                            <Rock:RockTemplateField HeaderText="Accounts">
                                <ItemTemplate><%# GetAccountDetails( Container.DataItem ) %></ItemTemplate>
            ...
            <Rock:ModalDialog ID="mdPledges" runat="server" Title="Active Pledges" OnCancelScript="clearActiveDialog();">
                <Content>
                    <Rock:Grid ID="gPledges" runat="server" EmptyDataText="No Pledges Found" RowItemText="Pledge" DisplayType="Light">
                        <Columns>
