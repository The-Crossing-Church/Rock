        ...
        protected IEntity CreateNewEntity( EncodedEntity encodedEntity )
        {
            ...
            if ( service != null )
            {
                ...
                if ( addMethod != null )
                {
                    ...
                    {
                        var attributeReference = encodedEntity.References.Where( r => r.Property == "AttributeId" ).FirstOrDefault();
                        var entityReference = encodedEntity.References.Where( r => r.Property == "EntityId" ).FirstOrDefault();
                        if ( attributeReference == null || entityReference == null )
                        {
                            return null;
                        }
