<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SurveyResultList_Crossing.ascx.cs" Inherits="RockWeb.Plugins.com_shepherdchurch.SurveySystem.SurveyResultList_Crossing" %>
        ...
        <asp:Panel ID="pnlResultList" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gList" runat="server" AllowSorting="true" ExportSource="ColumnOutput" >
                        <Columns>
