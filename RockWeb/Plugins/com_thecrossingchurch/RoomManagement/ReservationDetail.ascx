<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReservationDetail.ascx.cs" Inherits="RockWeb.Plugins.com_thecrossingchurch.RoomManagement.ReservationDetail" %>
