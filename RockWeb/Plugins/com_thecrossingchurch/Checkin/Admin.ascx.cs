...
{
    [DisplayName( "Administration (Contactless Check-in)" )]
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ...
                if ( SetConfigurationFromURL() )
                {
                    ...
                    string personIds = PageParameter(PageParameterKey.PersonIds);
                    if (personIds.IsNotNullOrWhiteSpace())
                    {
                        //queryParams.Add(PageParameterKey.PersonIds, personIds);
                        Session["PersonIds"] = personIds;
                    }
