...
<script type="module">
import eventActions from '/Scripts/com_thecrossingchurch/EventSubmission/EventActions.js?v=1.0.5';
...
import partialApproval from '/Scripts/com_thecrossingchurch/EventSubmission/PartialApproval.js?v=1.0.5';
