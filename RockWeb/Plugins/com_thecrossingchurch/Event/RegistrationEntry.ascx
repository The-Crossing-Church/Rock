<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntry.ascx.cs" Inherits="RockWeb.Plugins.com_thecrossingchurch.Event.RegistrationEntry" %>
...
<ContentTemplate>
    ...
    <asp:Panel ID="pnlSummaryAndPayment" runat="server" Visible="false" CssClass="registrationentry-summary">
        ...
        <asp:Panel ID="pnlRegistrarInfoPrompt" runat="server" CssClass="well">
            ...
            <h4>This <asp:Literal id="lRegistrationTermPrompt" runat="server" /> Is Being Submitted By</h4>
            <div class="row">
                <div class="col-md-6">
