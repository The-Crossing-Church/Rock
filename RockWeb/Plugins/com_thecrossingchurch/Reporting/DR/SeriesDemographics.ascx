<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SeriesDemographics.ascx.cs" Inherits="RockWeb.Plugins.com_thecrossingchurch.Reporting.DR.SeriesDemographics" %>
