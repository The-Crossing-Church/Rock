<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewsBySeries.ascx.cs" Inherits="RockWeb.Plugins.com_thecrossingchurch.Reporting.DR.ViewsBySeries" %>
                        ...
                        <div class="grid-row row grid-header">
                            <div class="col col-xs-8">
                                ...
                                <div class="d-flex" style="align-items: baseline;">
                                    <input id="series_filter" class="search-input" onkeypress="handleSeriesKeyPress(event)" />
                    ...
                    <div class="grid" id="views_by_tag">
                        <div class="grid-row row grid-header">
                            <div class="col col-xs-3">
                                ...
                                <div class="d-flex" style="align-items: baseline;">
                                    <input id="tag_filter" class="search-input" onkeypress="handleTopicKeyPress(event)" />
                                    <i class="fa fa-search" onclick="filterResultsByTag()"></i>
                                </div>
                            </div>
                            <div class="col col-xs-6">
                                Most Watched Item in Topic
                                <div class="pull-right">
...
<script>
    ...
    function getViewsBySeries() {
        const start = Date.now()
        $.ajax({
            type: "POST",
            url: window.location + "&isSeriesViewRequest=true",
            data: "",
    ...
    function getViewsByTag() {
        ...
        $.ajax({
            type: "POST",
            url: window.location + "&isTagViewRequest=true",
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (res) {
    ...
    function handleSeriesKeyPress(e) {
        if (e.keyCode === 13) {
            e.preventDefault()
            filterResultsBySeries()
        }
    }
