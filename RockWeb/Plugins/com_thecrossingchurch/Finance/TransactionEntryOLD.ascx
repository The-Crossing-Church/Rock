<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntryOLD.ascx.cs" Inherits="RockWeb.Plugins.com_thecrossingchurch.Finance.TransactionEntryOld" %>
