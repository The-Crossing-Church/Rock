...
namespace RockWeb.Plugins.com_thecrossingchurch.Groups
{
    /// <summary>
    /// 
    /// </summary>
    [DisplayName( "Group Registration" )]
    [Category( "com_thecrossingchurch > Groups" )]
    ...
    public partial class GroupRegistration : RockBlock
    {
        ...
        protected void btnRegister_Click( object sender, EventArgs e )
        {
            ...
            if ( Page.IsValid && _isValidSettings )
            {
                ...
                AddPersonToGroup( rockContext, person, workflowType, ref newGroupMembers );
                AddPersonToGroup( rockContext, spouse, workflowType, ref newGroupMembers );
        ...
        private void AddPersonToGroup( RockContext rockContext, Person person, WorkflowTypeCache workflowType, ref List<GroupMember> groupMembers )
        {
            if ( person != null )
            {
