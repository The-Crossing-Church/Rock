<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KindridImport.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Finance.KindridImport" %>
        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title">
                    <i class="fa fa-money"></i>&nbsp;Kindrid Transaction Import Tool</h3>
                </h1>
            </div>
            <div class="panel-body">
                ...
                <asp:Panel ID="pEntry" runat="server" Visible="true">
                    <div class="col-md-4">
                        <p>Please use the upload button below to upload a CSV file from Kindrid.</p>
                             ...
                             <div class="alert alert-danger">
                                <div class="row">
                                 ...
                                 <div class="row"><div class="col-md-12">
                                    ...
                                    <tbody>
                                    <asp:Repeater ID="rNotImported" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td style="background-color: #edeae6;"><strong><%# Eval("CurrentStatus") %></strong></td>
                                                <td><%# Eval("Name") %></td>
