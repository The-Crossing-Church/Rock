<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomFamilyRegistration.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.Checkin.CustomFamilyRegistration" %>
