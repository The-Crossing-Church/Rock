<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportDetailWithLava.ascx.cs" Inherits="RockWeb.Blocks.Reporting.ReportDetailWithPDF" %>
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            <asp:HiddenField ID="hfReportId" runat="server" />
                ...
                <div id="pnlViewDetails" runat="server">
                    <div id="pnlViewTop" runat="server">
                    <div class="panel panel-block">
                        <div class="panel-heading">
                    ...
                    <div class="panel panel-block">
                        ...
                        <div ID="pnlHeading" runat="server" class="panel-heading">
                            <div class="row margin-t-sm">
                                <div ID="pnlTitle" runat="server" class="col-md-6">
                                    <h1 class="panel-title"><i class="fa fa-table"></i> <asp:Literal ID="lReportTitle" runat="server" Visible="true" Text="Report Data" /></h1>
                                </div>
                        ...
                        <asp:Panel ID="pnlResultsGrid" runat="server">
                            <div class="panel-body">
                                <div class="grid grid-panel">
                                    ...
                                    <asp:Literal ID="lReport" runat="server" Visible="false" />
                                </div>
                            </div>
                        </asp:Panel>
                    </div>
