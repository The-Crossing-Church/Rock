...
namespace RockWeb.Blocks.Reporting
{
    ...
    [DisplayName( "Dynamic Report With Print" )]
    [Category( "Reporting" )]
    ...
    [LinkedPage("Print Action Page", "Page for displaying the report in a printable format.  Navigate to this page when print is clicked.", false)]
    ...
    public partial class DynamicReportWithPrint : RockBlockCustomSettings
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !string.IsNullOrWhiteSpace(printActionPage) )
            {
        ...
        void lbPrintBtn_Click(object sender, EventArgs e)
        {
            ...
            var url = string.Format("~/page/{0}?UsePrintableFormat=1&ReportId={1}&FilterJson={2}",
                rockPage.Id, reportId.Value, System.Web.HttpUtility.UrlPathEncode((dataViewFilterOverrides.ToJson())));
