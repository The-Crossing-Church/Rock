<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DynamicReportWithPrint.ascx.cs" Inherits="RockWeb.Blocks.Reporting.DynamicReportWithPrint" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server">
            ...
            <asp:Panel ID="pnlFilter" class="no-print" runat="server">
            ...
            <div class="panel panel-block margin-t-md">
                <div ID="pnlResultsHeader" runat="server" class="panel-heading clearfix">
                    <h1 class="panel-title pull-left">
