...
namespace RockWeb.Plugins.com_bemadev.Cms
{
    ...
    [TextField("Time Range Label", "", false, "", "CustomSetting", 4)]
    [BooleanField("Enable Group Filter", "Enables the group filter.", false, "CustomSetting", 5)]
    ...
    public partial class PageParameterFilter : RockBlockCustomSettings
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            _enableGroups = GetAttributeValue("EnableGroupFilter").AsBoolean();
        ...
        private void LoadFilters()
        {
            ...
            if (selectedGroupIds != null)
            {
                ...
                gpGroups.SetValues(groups.GetByIds(selectedGroupIds.SplitDelimitedValues(false).AsIntegerList()));
            }
        ...
        protected override void ShowSettings()
        {
            ...
            ddlEnableAccounts.SetValue(GetAttributeValue("EnableAccountFilter"));
            ...
            ddlEnableGroups.SetValue(GetAttributeValue("EnableGroupFilter"));
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            // Time Range
            if ( !tpTimeBeg.Text.IsNullOrWhiteSpace() && !tpTimeEnd.Text.IsNullOrWhiteSpace() )
            {
            ...
            //Group
            if (!String.IsNullOrWhiteSpace(gpGroups.SelectedValue) && gpGroups.SelectedValue != "0")
            {
                queryString.Set("GroupIds", gpGroups.SelectedValue);
            }
