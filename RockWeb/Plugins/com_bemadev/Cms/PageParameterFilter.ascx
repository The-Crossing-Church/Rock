                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnlEdit" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <Rock:RockDropDownList ID="ddlEnableAccounts" runat="server" Label="Enable Account Filter">
                                            <asp:ListItem Text="False" Value="False"></asp:ListItem>
                                            <asp:ListItem Text="True" Value="True"></asp:ListItem>
                                        </Rock:RockDropDownList>
                                    </div>
                                    ...
                                    <div class ="col-md-4">
                                        <Rock:RockDropDownList ID="ddlEnableGroups" runat="server" Label="Enable Group Filter">
                                            <asp:ListItem Text="False" Value="False"></asp:ListItem>
                                            <asp:ListItem Text="True" Value="True"></asp:ListItem>
                                        </Rock:RockDropDownList>
                                    </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div id ="gpGroupsDiv" runat="server" class="col-md-6" visible="false">
                        <Rock:GroupPicker ID="gpGroups" runat="server" Label="Groups" AllowMultiSelect="true" DisplayActiveOny="true"/>
                    </div>
                </div>
