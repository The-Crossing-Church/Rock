<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConnectionRequestDetailWithAttributes.ascx.cs" Inherits="RockWeb.Blocks.Connection.ConnectionRequestDetailWithAttributes" %>
