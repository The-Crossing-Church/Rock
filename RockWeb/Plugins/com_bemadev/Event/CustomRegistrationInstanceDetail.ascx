<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomRegistrationInstanceDetail.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.Event.CustomRegistrationInstanceDetail" %>
