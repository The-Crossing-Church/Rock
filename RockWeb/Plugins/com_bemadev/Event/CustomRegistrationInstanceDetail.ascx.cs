...
namespace RockWeb.Plugins.com_bemadev.Event
{
    /// <summary>
    /// Template block for developers to use to start a new block.
    /// </summary>
    [DisplayName( "Custom Registration Instance Detail" )]
    [Category( "com_bemadev > Event" )]
    ...
    public partial class CustomRegistrationInstanceDetail : Rock.Web.UI.RockBlock, IDetailBlock
    {
        #region Fields
                    ...
                    if ( field.FieldSource == RegistrationFieldSource.PersonField && field.PersonFieldType.HasValue )
                    {
                        switch ( field.PersonFieldType.Value )
                        {
                            ...
                            case RegistrationPersonFieldType.ConnectionStatus:
                                var ddlConnectionStatusFilter = phRegistrantsRegistrantFormFieldFilters.FindControl ( "ddlRegistrantsConnectionStatusFilter" ) as RockDropDownList;
                                if ( ddlConnectionStatusFilter != null )
                                {
                                    fRegistrants.SaveUserPreference ( "Conneciton Status", ddlConnectionStatusFilter.SelectedValue );
                                }
                    ...
                    if ( field.FieldSource == RegistrationFieldSource.PersonField && field.PersonFieldType.HasValue )
                    {
                        switch ( field.PersonFieldType.Value )
                        {
                            ...
                            case RegistrationPersonFieldType.ConnectionStatus:
                                ...
                                if ( ddlConnectionStatusFilter != null )
                                {
                                    ddlConnectionStatusFilter.SetValue ( (Guid?) null );
                                }
        ...
        protected void fRegistrants_DisplayFilterValue( object sender, GridFilter.DisplayFilterValueArgs e )
        {
            ...
            switch ( e.Key )
            {
                ...
                case "Connection Status":
                    int? csId = e.Value.AsIntegerOrNull ();
                    if ( csId.HasValue )
                    {
                        var ConnectionStatus = DefinedValueCache.Get ( csId.Value );
                ...
                foreach ( var field in RegistrantFields )
                {
                    if ( field.FieldSource == RegistrationFieldSource.PersonField && field.PersonFieldType.HasValue )
                    {
                        switch ( field.PersonFieldType.Value )
                        {
                            ...
                            case RegistrationPersonFieldType.ConnectionStatus:
                                var ddlConnectionStatusFilter = phWaitListFormFieldFilters.FindControl ( "ddlWaitlistConnectionStatusFilter" ) as RockDropDownList;
                                if ( ddlConnectionStatusFilter != null )
                                {
                                    fWaitList.SaveUserPreference ( "WL-Connection Status", "Connection Status", ddlConnectionStatusFilter.SelectedValue );
                                }
                            ...
                            .Select( f => f.PersonFieldType.Value ) )
                        {
                            switch ( personFieldType )
                            {
                                ...
                                case RegistrationPersonFieldType.ConnectionStatus:
                                    ...
                                    if ( ddlConnectionStatusFilter != null )
                                    {
                                        var ConnectionStatusId = ddlConnectionStatusFilter.SelectedValue.AsIntegerOrNull ();
                    ...
                    if ( field.FieldSource == RegistrationFieldSource.PersonField && field.PersonFieldType.HasValue )
                    {
                        switch ( field.PersonFieldType.Value )
                        {
                            ...
                            case RegistrationPersonFieldType.MaritalStatus:
                                ...
                                maritalStatusField2.HeaderText = "Marital Status";
                                ...
                                maritalStatusField3.HeaderText = "Marital Status";
                            ...
                            case RegistrationPersonFieldType.ConnectionStatus:
                                var ddlRegistrantsConnectionStatusFilter = new RockDropDownList ();
                                ddlRegistrantsConnectionStatusFilter.BindToDefinedType ( DefinedTypeCache.Get ( Rock.SystemGuid.DefinedType.PERSON_CONNECTION_STATUS.AsGuid () ), true );
                                ddlRegistrantsConnectionStatusFilter.ID = "ddlRegistrantsConnectionStatusFilter";
                                ddlRegistrantsConnectionStatusFilter.Label = "Connection Status";

                                if ( setValues )
                                {
                                    ddlRegistrantsConnectionStatusFilter.SetValue ( fRegistrants.GetUserPreference ( "Connection Status" ) );
                                }

                                phRegistrantsRegistrantFormFieldFilters.Controls.Add ( ddlRegistrantsConnectionStatusFilter );

                                var ddlGroupPlacementsConnectionStatusFilter = new RockDropDownList ();
                                ddlGroupPlacementsConnectionStatusFilter.BindToDefinedType ( DefinedTypeCache.Get ( Rock.SystemGuid.DefinedType.PERSON_CONNECTION_STATUS.AsGuid () ), true );
                                ddlGroupPlacementsConnectionStatusFilter.ID = "ddlGroupPlacementsConnectionStatusFilter";
                                ddlGroupPlacementsConnectionStatusFilter.Label = "Connection Status";

                                if ( setValues )
                                {
                                    ddlGroupPlacementsConnectionStatusFilter.SetValue ( fGroupPlacements.GetUserPreference ( "GroupPlacements-Connection Status" ) );
                                }

                                phGroupPlacementsFormFieldFilters.Controls.Add ( ddlGroupPlacementsConnectionStatusFilter );

                                var ddlWaitlistConnectionStatusFilter = new RockDropDownList ();
                                ddlWaitlistConnectionStatusFilter.BindToDefinedType ( DefinedTypeCache.Get ( Rock.SystemGuid.DefinedType.PERSON_CONNECTION_STATUS.AsGuid () ), true );
                                ddlWaitlistConnectionStatusFilter.ID = "ddlWaitlistConnectionStatusFilter";
                                ddlWaitlistConnectionStatusFilter.Label = "Connection Status";
                                ddlWaitlistConnectionStatusFilter.SetValue ( fRegistrants.GetUserPreference ( "WL-Connection Status" ) );
                                phWaitListFormFieldFilters.Controls.Add ( ddlWaitlistConnectionStatusFilter );
                                ...
                                gRegistrants.Columns.Add ( ConnectionStatusField );

                                var ConnectionStatusField2 = new RockBoundField ();
                                ConnectionStatusField2.DataField = dataFieldExpression;
                                ConnectionStatusField2.HeaderText = "Connection Status";
                                ConnectionStatusField2.SortExpression = dataFieldExpression;
                                gGroupPlacements.Columns.Add ( ConnectionStatusField2 );

                                var ConnectionStatusField3 = new RockBoundField ();
                                ConnectionStatusField3.DataField = dataFieldExpression;
                                ConnectionStatusField3.HeaderText = "Connection Status";
                                ConnectionStatusField3.SortExpression = dataFieldExpression;
                                gWaitList.Columns.Add ( ConnectionStatusField3 );
                    ...
                    if ( RegistrantFields != null )
                    {
                            ...
                            .Select( f => f.PersonFieldType.Value ) )
                        {
                            switch ( personFieldType )
                            {
                                ...
                                case RegistrationPersonFieldType.ConnectionStatus:
                                    var ddlConnectionStatusFilter = phGroupPlacementsFormFieldFilters.FindControl ( "ddlGroupPlacementsConnectionStatusFilter" ) as RockDropDownList;
                                    if ( ddlConnectionStatusFilter != null )
                                    {
                                        var ConnectionStatusId = ddlConnectionStatusFilter.SelectedValue.AsIntegerOrNull ();
                                        if ( ConnectionStatusId.HasValue )
