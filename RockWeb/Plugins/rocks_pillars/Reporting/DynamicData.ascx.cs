...
namespace RockWeb.Plugins.rocks_pillars.Reporting
{
    ...
    /// </summary>
    /// <remarks>
    /// Cloned version 9.3 of core block with following changes
    ...
    [TextField( "Currency Fields", "Any fields that should be displayed as a currency value", false, "", "CustomSetting" )]
    ...
    [KeyValueListField( "Custom Actions", "List of custom actions and the URL that user should be redirected to when an action is selected. An EntityList will be created with the selected item before user is redirected", false, "", "Action", "Url", "", "", "CustomSettings" )]
    [TextField( "File Name", "If a value is entered here, the resuts of the formatted text will be saved to a file and automatically downloaded.", false, "", "File Download", 0)]
    [TextField( "File Mime Type", "The mime type to use for the file being downloaded.", false, "", "File Download", 1 )]
    public partial class DynamicData : RockBlockCustomSettings
    {
        ...
        protected void lbSave_Click( object sender, EventArgs e )
        {
            ...
            SetAttributeValue( "CustomActions", kvlActions.Value );
            SetAttributeValue( "MergeFields", tbMergeFields.Text );
            SetAttributeValue( "CurrencyFields", tbCurrencyFields.Text );
        ...
        protected override void ShowSettings()
        {
            ...
            kvlActions.Value = GetAttributeValue( "CustomActions" );
            tbMergeFields.Text = GetAttributeValue( "MergeFields" );
            tbCurrencyFields.Text = GetAttributeValue( "CurrencyFields" );
        ...
        private Dictionary<string, string> GetCustomActionList()
        {
            ...
            var actionsString = GetAttributeValue( "CustomActions" );
        ...
        private void BuildControls( bool setData )
        {
            ...
            else
            {
                ...
                if ( dataSetSchema != null )
                {
                    ...
                    {
                        string outputText = formattedOutput.ResolveMergeFields( mergeFields );
                ...
                if ( grid != null )
                {
                    ...
                    if ( itemsSelected.Any() )
                    {
                        ...
                        { 
                            ...
                            string url = ddlAction.SelectedValue;
        ...
        private void AddGridColumns( Grid grid, DataTable dataTable )
        {
            ...
            var currencyFields = GetAttributeValue( "CurrencyFields" ).SplitDelimitedValues().ToList();
            ...
            if ( !string.IsNullOrWhiteSpace( grid.PersonIdField )
                ...
                || GetAttributeValue( "CustomActions" ).IsNotNullOrWhiteSpace() )
            {
            ...
            foreach ( DataColumn dataTableColumn in dataTable.Columns )
            {
                ...
                {
                    if ( currencyFields.Contains( dataTableColumn.ColumnName ) )
                    {
