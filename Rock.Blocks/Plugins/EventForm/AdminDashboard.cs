    ...
    WHERE @Status IS NULL
       OR StatusFilter.Status IS NOT NULL;
        ...
        private void PartialApprovalNotifications( ContentChannelItem item, List<string> approved, List<string> denied, List<EventPartialApproval> events, string notes )
        {
            ...
            helper.InitializeEventFormHelper( EventContentChannelId, EventDetailsContentChannelId, EventChangesContentChannelId, EventDetailsChangesContentChannelId, "RoomSetUp", "DiscountCodes", "OpsInventory", "AdditionalRegistrationQuestions" );
