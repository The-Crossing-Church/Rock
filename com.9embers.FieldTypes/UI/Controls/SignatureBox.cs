...
namespace com._9embers.FieldTypes.UI.Controls
{
    /// <summary>
    /// Signature Control
    /// </summary>
    ...
    public class SignatureBox : CompositeControl, IRockControl
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            {
                RockPage.AddScriptLink( Page, ResolveUrl( "~/Scripts/com_9embers/signature_pad.min.js" ), false );
            }
        }
...
";
    ...
    function resizeCanvas_{ClientID}() {{
        ...
        $('canvas.signature-pad_{ClientID}').each(function () {{
            var canvas = $(this)[0];
            if(canvas.offsetWidth !== cachedWidth_{ClientID})
            {{
                cachedWidth_{ClientID} = canvas.offsetWidth;
...
";
            ...
            {
                ScriptManager.RegisterClientScriptInclude( this.Page, this.Page.GetType(), "signature-pad", ( (RockPage)this.Page ).ResolveRockUrl( "~/Scripts/com_9embers/signature_pad.min.js", false ) );
            }
