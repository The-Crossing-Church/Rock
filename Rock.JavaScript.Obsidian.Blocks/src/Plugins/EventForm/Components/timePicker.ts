...
<div>
  ...
  <rck-modal v-model="menu" :isCloseButtonHidden="true" cancelText="" :clickBackdropToClose="true" saveText="Save" @save="menu = false" isNarrow modalWrapperClasses="modal-no-header">
    <div class="time-menu">
      <div class="row">
