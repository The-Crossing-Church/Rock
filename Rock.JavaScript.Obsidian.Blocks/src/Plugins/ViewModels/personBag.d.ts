...
import { PhoneNumberBag } from "./phoneNumberBag";
...
export type PersonBag = {
    ...
    phoneNumbers?: PhoneNumberBag[] | null;

    /** New Family Registration Custom Props */
    phoneNumberCantBeMessaged?: boolean | null;
};
