...
<a-badge :count="commentNotification">
  <a-pop v-model:visible="visible" trigger="click" placement="right">
    <template #content>
      ...
      <a-btn class="mr-1" shape="circle" type="grey" v-if="!request.attributeValues.RequestStatus.includes('Cancelled')" @click="updateStatus(request.idKey, 'Cancelled by User')">
        <i class="fa fa-ban"></i>
      </a-btn>
